...
public class DataInitializer {
    public static void init(UsuarioRepository usuarioRepo, PartidoRepository partidoRepo) {
        ...
        Partido partido1 = new Partido(Deporte.FUTBOL, 2, 10, new Ubicacion(1, 1), horarioPartidoLuis, new NecesitamosJugadores(), new EmparejamientoPorUbicacion(), Arrays.asList(Luis), Nivel.AVANZADO);
        ...
        Partido partido2 = new Partido(Deporte.VOLEY, 3, 10, new Ubicacion(1, 1), horarioPartidoAna, new NecesitamosJugadores(), new EmparejamientoPorNivel(), Arrays.asList(Ana), Nivel.INTERMEDIO);
        ...
        Partido partido3 = new Partido(Deporte.VOLEY, 2, 8, new Ubicacion(20, 20), horarioPartidoSofia, new NecesitamosJugadores(), new EmparejamientoPorUbicacion(), Arrays.asList(Sofia), Nivel.INTERMEDIO);
        ...
        Partido partido4 = new Partido(Deporte.BASQUET, 2, 6, new Ubicacion(6, 1), horarioPartidoMartin, new NecesitamosJugadores(), new EmparejamientoPorNivel(), Arrays.asList(Martin), Nivel.INTERMEDIO);
